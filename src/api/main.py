...
app = FastAPI(
    ...
    description=(
        ...
        "This application is part of the MLOps Bootcamp by Prodigy Devops Solutions. "
        "Authored by Raj Shaker Pisupati."
    ),
    version="1.0.0",
    contact={
        "name": "Prodigy Devops Solutions",
        "url": "https://prodigydevops.com",
        "email": "learn@prodigydevops.com",
    },
    license_info={
        "name": "Apache 2.0",
